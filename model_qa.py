...
class ElectraForQuestionAnswering(ElectraPreTrainedModel):
    ...
    def forward(
        ...
        discriminator_hidden_states = self.electra( # electra base model 
            input_ids,
        ...
        sequence_output = discriminator_hidden_states[0] # size : [bsz,seq_len(512),hidden_size] 
        print(sequence_output.size()) ; exit()
        logits = self.qa_outputs(sequence_output)
        start_logits, end_logits = logits.split(1, dim=-1)
        #print('1st',start_logits.shape)
